  ...
  return (
    <main className="flex flex-col items-center p-8">
      ...
      <section className="w-[50%] m-10 flex flex-col gap-4">
        <h1 className="text-4xl font-bold">Accelerate your projects with top talent</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet deleniti perspiciatis nulla aut itaque voluptatum est soluta beatae accusantium, voluptatibus, autem voluptatem rerum, rem consequuntur velit nemo reprehenderit asperiores illo.</p>
        <div className="flex gap-4 w-full justify-center">
          <button className="btn primary bg-cyan-400">Browse projects<FaArrowRight /></button>
      ...
      <div className="flex gap-2 justify-between w-full mb-10">
        <div div className="w-50 max-w-sm rounded-2xl bg-white p-6 shadow-xl border border-gray-100">
        ...
        <div div className="w-50 max-w-sm rounded-2xl bg-slate-700 p-6 shadow-xl border border-gray-100">
          <div className="flex items-center justify-between h-40">
            <div>
        ...
        <div div className="w-50 max-w-sm rounded-2xl bg-gray-300 p-6 shadow-xl border border-gray-100">
          <div className="flex items-center justify-between h-40">
            <div>
        ...
        <div div className="w-50 max-w-sm rounded-2xl bg-cyan-400 p-6 shadow-xl border border-gray-100">
          <div className="flex items-center justify-between h-40">
            <div>
              <p className="text-sm font-medium text-gray-500">Avg bids per project</p>
      ...
      <section className="bg-stone-600 w-full rounded-lg text-olive-100">
        <div className="w-[50%] text-start p-8">
          <p className="font-bold mb-4">FREELANCER TESTIMONIAL</p>
          <p className="text-2xl">"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor nam odit ea veritatis molestias, porro quam non consequatur! Quidem accusamus deserunt vitae quae cumque nulla alias tempora pariatur. Alias, hic?"</p>
